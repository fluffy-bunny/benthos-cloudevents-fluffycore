...
type ProcessCloudEventsRequest struct {
	...
	Event *cloudevents.CloudEvent `protobuf:"bytes,1,opt,name=event,proto3" json:"event,omitempty"`
}
...
func (x *ProcessCloudEventsRequest) GetEvent() *cloudevents.CloudEvent {
	if x != nil {
		return x.Event
	}
	return nil
...
var file_pkg_proto_cloudeventprocessor_cloudeventprocessor_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x50, 0x0a, 0x19, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6c, 0x6f, 0x75,
	0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33,
	...
	0x31, 0x2e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x22, 0x1c, 0x0a, 0x1a, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43, 0x6c,
...
var file_pkg_proto_cloudeventprocessor_cloudeventprocessor_proto_goTypes = []interface{}{
	...
	(*cloudevents.CloudEvent)(nil),     // 2: io.cloudevents.v1.CloudEvent
}
var file_pkg_proto_cloudeventprocessor_cloudeventprocessor_proto_depIdxs = []int32{
	2, // 0: pkg.proto.cloudeventprocessor.ProcessCloudEventsRequest.event:type_name -> io.cloudevents.v1.CloudEvent
